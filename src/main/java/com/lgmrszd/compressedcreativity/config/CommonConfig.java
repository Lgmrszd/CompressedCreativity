...
public class CommonConfig {
    ...
    static {
        ...
        ROTATIONAL_COMPRESSOR_PRESSURE_TIER = COMMON_BUILDER.comment("Pressure Tier of the machine").defineEnum("pressure_tier", PressureTierConfig.PressureTierEnum.TIER_ONE);
        ...
        AIR_BLOWER_PRESSURE_TIER = COMMON_BUILDER.comment("Pressure Tier of the machine\nAll but CUSTOM one match Pressure Tiers from PNC:R").defineEnum("pressure_tier", PressureTierConfig.PressureTierEnum.TIER_ONE);
