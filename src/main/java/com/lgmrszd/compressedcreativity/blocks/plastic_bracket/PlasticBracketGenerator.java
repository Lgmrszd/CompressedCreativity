...
public class PlasticBracketGenerator extends DirectionalAxisBlockStateGen {
    ...
    public PlasticBracketGenerator(String material) {
    ...
    public <T extends Block> ModelFile getModel(DataGenContext<Block, T> ctx, RegistrateBlockstateProvider prov,
        ...
        return prov.models()
                ...
                .texture("bracket", prov.modLoc("block/plastic_bracket/bracket_" + material))
                .texture("plate", prov.modLoc("block/plastic_bracket/bracket_plate_" + material));
    }
    ...
    public static <I extends BlockItem, P> NonNullFunction<ItemBuilder<I, P>, P> itemModel(String material) {
        return b -> b.model((c, p) -> p.withExistingParent(c.getName(), p.modLoc("block/bracket/item"))
                        .texture("bracket", p.modLoc("block/plastic_bracket/bracket_" + material))
                        .texture("plate", p.modLoc("block/plastic_bracket/bracket_plate_" + material)))
                .build();
    }
}
