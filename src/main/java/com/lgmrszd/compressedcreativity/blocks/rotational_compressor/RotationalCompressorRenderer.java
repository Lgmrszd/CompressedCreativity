...
public class RotationalCompressorRenderer extends KineticBlockEntityRenderer<RotationalCompressorBlockEntity> {
    ...
    @Override
    protected void renderSafe(RotationalCompressorBlockEntity be, float partialTicks, PoseStack ms, MultiBufferSource buffer,
